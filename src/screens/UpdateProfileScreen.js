...
import FastImage from '../components/authentic/FastImage';
import { useUserState } from '../contexts/UserContext';
import { MaterialCommunityIcons } from '@expo/vector-icons';
import { GRAY, WHITE } from '../colors';
import HeaderRight from '../components/authentic/HeaderRight';
import { useCallback, useEffect, useLayoutEffect, useState } from 'react';
import { updateUserInfo } from '../api/auth';
import SafeInputView from '../components/authentic/SafeInputView';
import { MainRoutes } from '../navigations/routes';
import { getLocalUri } from '../components/authentic/ImagePicker';
