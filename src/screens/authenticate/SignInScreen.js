...
import Input, {
  InputTypes,
  ReturnKeyTypes,
} from '../../components/authenticate/Input';
import { useCallback, useReducer, useRef } from 'react';
import Button from '../../components/authenticate/Button';
import SafeInputView from '../../components/authenticate/SafeInputView';
import { useSafeAreaInsets } from 'react-native-safe-area-context';
import TextButton from '../../components/authenticate/TextButton';
import { useFocusEffect, useNavigation } from '@react-navigation/native';
import { AuthRoutes } from '../../navigations/routes';
import HR from '../../components/authenticate/HR';
...
import {
  ...
  AuthFormTypes,
  initAuthForm,
} from '../../api/reducers/authFormReducer';
