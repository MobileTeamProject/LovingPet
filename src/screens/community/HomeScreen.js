            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <ScrollView style={styles.container}>
                    <View style={styles.boardContainer}>
                        <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 10 }}>메인 게시판</Text>
                        ...
                        <TouchableOpacity activeOpacity={0.8} style={styles.button}>
                            <MaterialCommunityIcons name="heart-plus" size={24} color="#745454" />
                            <Text style={styles.board}>의료 정보 게시판</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.boardContainer}>
                        <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 10 }}>기타 게시판</Text>
                        <TouchableOpacity activeOpacity={0.8} style={styles.button}>
                            <MaterialCommunityIcons name="cart-heart" size={24} color="#745454" />
                            <Text style={styles.board}>핫딜 게시판</Text>
                        </TouchableOpacity>
                        <TouchableOpacity activeOpacity={0.8} style={styles.button}>
                            <MaterialCommunityIcons name="wallet-travel" size={24} color="#745454" />
                        ...
                        <TouchableOpacity activeOpacity={0.8} style={styles.button}>
                            <MaterialCommunityIcons name="format-wrap-square" size={24} color="#745454" />
                            <Text style={styles.board}>사진 게시판</Text>
                        </TouchableOpacity>
                        <TouchableOpacity activeOpacity={0.8} style={styles.button}>
                            <MaterialCommunityIcons name="campfire" size={24} color="#745454" />
